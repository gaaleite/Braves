...
# LINK DA SUA PLANILHA (Cole aqui o link normal de compartilhamento da sua planilha)
...
def carregar_aba_google(url_planilha, nome_aba):
    try:
        # Transforma o link público em um link de download de dados CSV limpo
...
# -------------------------------------------------------------------------
# Carrega as configurações de abas direto do Google Drive inicialmente
if "lista_abas" not in st.session_state:
    ...
    if not df_abas.empty and "nome_aba" in df_abas.columns:
        ...
        # Fallback caso a planilha esteja completamente vazia ou inacessível
